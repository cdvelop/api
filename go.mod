...
require (
	...
	github.com/cdvelop/testools v0.0.40
)
...
require (
	github.com/cdvelop/fetchserver v0.0.4 // indirect
	github.com/cdvelop/filehandler v0.0.7
	github.com/cdvelop/fileserver v0.0.26
	github.com/cdvelop/logserver v0.0.5 // indirect
