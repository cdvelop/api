...
require (
	github.com/cdvelop/filehandler v0.0.47
...
require (
	github.com/cdvelop/cutkey v1.0.18 // indirect
	github.com/cdvelop/fetchserver v0.0.27 // indirect
	github.com/cdvelop/logserver v0.0.42 // indirect
